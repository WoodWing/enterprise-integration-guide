...
|  40      | CreateIssue <sup>18)</sup>       | 10.4.1     | Ticket <sup>9)</sup>, PublicationId, PubChannelId, Id (issue), Name (issue), OverrulePublication <sup>17) 27)</sup>, Activated <sup>16)</sup>, PublicationDate, ReversedRead <sup>27)</sup>, Description <sup>14)</sup>, Subject <sup>14)</sup>
|  41      | ModifyIssue <sup>18)</sup>       | 10.4.1     | Ticket <sup>9)</sup>, PublicationId, PubChannelId, Id (issue), Name (issue), OverrulePublication <sup>17) 27)</sup>, Activated <sup>16)</sup>, PublicationDate, ReversedRead <sup>27)</sup>, Description <sup>14)</sup>, Subject <sup>14)</sup>
...
25. The message fields `SupportsForms` and `SupportsCropping` are discontinued since 10.11.0 and always a `false` value is provided.

26. The message field `DirectPublish` is discontinued since 10.12.0 and is no longer included in the message.

27. The message fields `OverrulePublication` and `ReversedRead` are discontinued since 10.9.0 and always a `false` value is provided. 
