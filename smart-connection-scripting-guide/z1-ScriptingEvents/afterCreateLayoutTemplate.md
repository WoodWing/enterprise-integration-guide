...
After creating a new layout template in the Studio Server system. This includes Save As.
...
**Using afterCreateLayoutTemplate**

```javascript
var msg = "Created layout template ID: " + app.scriptArgs.get("Core_ID");
alert(msg);
```
